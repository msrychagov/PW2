...
final class WishMakerViewController: UIViewController {
    ...
    private enum Constants {
        ...
        static let titleWidth: CGFloat = 400
        static let descriptionHeight: CGFloat = 50
        static let descriptionWidth: CGFloat = 400
        ...
        static let toggleButtonWidth: CGFloat = 200
    }
    ...
    private func configureToggleButton() {
            ...
            toggleButton.pinBottom(to: stack.topAnchor, 20)
        }
